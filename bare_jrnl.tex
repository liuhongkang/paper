...
\begin{table*}[t]
  ...
  \begin{tabular}{|m{1.6cm}<{\centering}|m{1.8cm}<{\centering}|m{1.6cm}<{\centering}|m{1.6cm}<{\centering}|m{1.6cm}<{\centering}|m{1.6cm}<{\centering}|m{1.6cm}<{\centering}|m{1.6cm}<{\centering}|}
    ...
    \hline
    \multirow{3}*{\textbf{Sequence1}} & $\bm{\overline{SCR_{gain}}}$ & 6.03 & 18.44&1.25&56.38&1.26&\textbf{354.92}\\
    \cline{2-8}
    ~& $\bm{\overline{BSF}}$ & 1.53 & 3.31&1.61&2.75&16.70&\textbf{17.6}\\
    \cline{2-8}
    ~& $\bm{\overline{LSNR_{gain}}}$ & 0.72 & 1.57&0.70&1.93&0.17&\textbf{8.46}\\
    \hline
    \multirow{3}*{\textbf{Sequence2}} & $\bm{\overline{SCR_{gain}}}$ & 34.52 & 25.96&5.41&4.88&19.77&\textbf{1241.51}\\
    \cline{2-8}
    ~& $\bm{\overline{BSF}}$ & 66.47 & 33.97 &6.23&5.87&124.88&\textbf{605.36}\\
    \cline{2-8}
    ~& $\bm{\overline{LSNR_{gain}}}$ & 10.90 & 15.66&3.59&5.96&4.45&\textbf{148.39}\\
    \hline
    \multirow{3}*{\textbf{Sequence1}} & $\bm{\overline{SCR_{gain}}}$ & 1.10 & 4.08&2.06&8.88&5.34&\textbf{3859.11}\\
    \cline{2-8}
    ~& $\bm{\overline{BSF}}$ & 2.06 & 3.14 &2.87&2.47&5.64&\textbf{739.20}\\
    \cline{2-8}
    ~& $\bm{\overline{LSNR_{gain}}}$ & 0.15 & 0.44&0.43&2.56&0.12&\textbf{97.97}\\
    \hline
    \multirow{3}*{\textbf{Sequence1}} & $\bm{\overline{SCR_{gain}}}$ & 3846.50 & 702.54&19.16&12.67&4.68&\textbf{Inf}\\
    \cline{2-8}
...
\begin{table*}[t]
  ...
  \begin{tabular}{|m{1.6cm}<{\centering}|m{1.8cm}<{\centering}|m{1.6cm}<{\centering}|m{1.6cm}<{\centering}|m{1.6cm}<{\centering}|m{1.6cm}<{\centering}|m{1.6cm}<{\centering}|m{1.6cm}<{\centering}|}
    ...
    \textbf{sequence} & \textbf{metrics} & \textbf{IPI} & \textbf{MPCM} & \textbf{RIPT} & \textbf{STLCF} & \textbf{STSA} & \textbf{ours}\\
    \hline
    \multirow{3}*{\textbf{Sequence1}} & $\bm{\overline{SCR_{gain}}}$ & \textbf{Inf} & 18137.84 & \textbf{Inf} & 18280.23 & 1484.88 &\textbf{Inf}\\
    \cline{2-8}
    ...
    \hline
    \multirow{3}*{\textbf{Sequence2}} & $\bm{\overline{SCR_{gain}}}$ & 107.88 & 19.67 & 92.90 & 24.89 &93.21 &\textbf{343.29}\\
    \cline{2-8}
    ~& $\bm{\overline{BSF}}$ & 44.54 & 8.58 & 29.71 & 9.91 &7.63 &\textbf{76.26}\\
    \cline{2-8}
    ~& $\bm{\overline{LSNR_{gain}}}$ & 11.80 & 2.25 & 4.75 & 9.88 & 3.32 &\textbf{17.20}\\
    \hline
    \multirow{3}*{\textbf{Sequence3}} & $\bm{\overline{SCR_{gain}}}$ & 85.08 & 82.51 & \textbf{Inf} & 6.15 & 31.78 &\textbf{Inf}\\
    \cline{2-8}
    ~& $\bm{\overline{BSF}}$ & 27.57 & 31.44 & \textbf{Inf} & 1.10 & 2.60 &\textbf{Inf}\\
    \cline{2-8}
    ~& $\bm{\overline{LSNR_{gain}}}$ & 5.79 & 11.96 & \textbf{Inf} & 2.40 &1.66 &\textbf{Inf}\\
    \hline
    \multirow{3}*{\textbf{Sequence4}} & $\bm{\overline{SCR_{gain}}}$ & 8.62 & 13.04 & 5.60 & 4.35 & 0.93 &\textbf{28.17}\\
    \cline{2-8}
